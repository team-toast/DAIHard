...
updateCreationInfo creationInfo trade =
    case trade of
        ...
        LoadedTrade _ ->
            let
                _ =
                    maybeDebugLog "Trying to update creation info on a trade that's already fully loaded!" ""
            in
            trade
...
updateParameters parameters trade =
    case trade of
        ...
        LoadedTrade info ->
            let
                _ =
                    maybeDebugLog "Trying to update parameters on a trade that's already fully loaded!" ""
            in
            trade
...
updateTerms terms trade =
    case trade of
        ...
        LoadedTrade info ->
            let
                _ =
                    maybeDebugLog "Trying to update terms on a trade that's already fully loaded!" ""
            in
            trade
